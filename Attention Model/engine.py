...
from models_attention import BertRNNWithSpeakerAttention
...
class Engine:
    def __init__(self, args):
        ...
        model = BertRNNWithSpeakerAttention(
                                nlayer=args.nlayer,
                                nclass=args.nclass,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--attention_heads', type=int, default=4, help='number of attention heads in speaker attention')
